...
<body>
	...
	<div class="warp">
			...
			<div class="row gx-1">
				...
				<div class="col-2">
					...
					<div class="side_result">
						...
						<span>총 <span class="em_numer">31</span>건
						</span>
					</div>
				</div>
		...
		<!-- 첫번째 컨텐츠 구역 end -->
	<div id="content2_box"> <!-- 글쓰기버튼 , 작성목록창 end -->
		<div class="list_btn">
			<a href="main_write.jsp"><button type="button"
					id="btn1" class="btn btn-outline-info" onclick="onWrite()">글쓰기</button></a>
		</div>
			...
			<table class="table table-striped">
				<tfoot class="content2 table-light">
					...
					<tr height="60px">
						...
						<td class="td_02" width="70%">가입시 아이디를 잘못해서 바꾸고 싶은데 변경할 수
							있나요?</td>
						<td class="td_03" width="12%">계정</td>
						<td>2017-11-20</td>
					</tr>
		...
		<div id="content3">
			...
			<ul class="info1">
				...
				<li class="li_03">가까운 점포를 찾기 어려우시거나 문의 내용이 있을 경우</br>고객상담실로 문의 하세요.
				</li>
			</ul>
