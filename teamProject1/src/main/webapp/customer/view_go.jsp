...
<div class="container">	<!-- 전체구역 -->
	<div class="q">
		<img  src="../img/img_go/icon_back.png" class="icon1" onclick="back()">자주하는질문<!-- 사이즈 조절 필요 -->
...
<!-- 		<span class="v_selectInput">계정</span>
 ...
 -->					
			...
			<div class="col-1"> <a href="update_go.jsp"> <input class="form-control" type="button" value="수정하기"> </a>  </div>
